...
const ProjectCard = ({ title, category, bgColor, size = 'normal', href = '#' }) => {
...
export default function Works() {
  const projects = [
    { title: 'A+ NAIL SCHOOL', category: 'Trade School & Education', size: 'normal', bgColor: '#f5ede6', href: '/works/a-plus-nail-school' },
    { title: 'HIHIVE', category: 'Community Platform', size: 'tall', bgColor: '#f0f0f0', href: '/works' },
    { title: 'WHITECAP', category: 'Professional Services', size: 'normal', bgColor: '#f5ede6', href: '/works' },
    { title: 'KCS', category: 'Education Technology', size: 'normal', bgColor: '#f0f0f0', href: '/works' },
    { title: 'HAMAM', category: 'Luxury Wellness', size: 'tall', bgColor: '#d4f949', href: '/works' },
    { title: 'ABS FRENCH SCHOOL', category: 'Education', size: 'normal', bgColor: '#1a1a1a', href: '/works' }
  ];
